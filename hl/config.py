...
# Daily post-scan portfolio tuner. It only moves the three first-open margin percentages; leverage,
# coin caps, deploy cap, stop settings and add rules remain operator-controlled risk boundaries.
AUTO_TUNE_MARGIN_ENABLE = True
AUTO_TUNE_MARGIN_MULTS = (0.75, 1.0, 1.25, 1.5)
AUTO_TUNE_MARGIN_DAYS = (30, 14, 7)
AUTO_TUNE_MARGIN_MIN_OPEN_FIT = 0.75
AUTO_TUNE_MARGIN_MAX_OPEN_FIT_DROP = 0.03
