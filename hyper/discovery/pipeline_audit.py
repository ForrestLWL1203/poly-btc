    ...
    for r in rows:
        ...
        payload = {
            ...
            "copyBt": {
                ...
                "30dClosedNetPnl": r.get("copy_bt_closed_net_pnl"),
                "30dUnrealizedPnl": r.get("copy_bt_unrealized_pnl"),
                "30dClosedN": r["copy_bt_closed_n"],
                "14dNetPnl": r["copy_bt_14d_net_pnl"],
                "14dClosedNetPnl": r.get("copy_bt_14d_closed_net_pnl"),
                "14dUnrealizedPnl": r.get("copy_bt_14d_unrealized_pnl"),
                "14dClosedN": r["copy_bt_14d_closed_n"],
                "7dNetPnl": r["copy_bt_7d_net_pnl"],
                "7dClosedNetPnl": r.get("copy_bt_7d_closed_net_pnl"),
                "7dUnrealizedPnl": r.get("copy_bt_7d_unrealized_pnl"),
                "7dClosedN": r["copy_bt_7d_closed_n"],
                "profitabilityBasis": qualification.get("profitabilityBasis"),
                "economics": qualification.get("economics"),
            ...
            "sourceQuality": {
                ...
                "episodes7d": r.get("source_episode_n_7d"),
                "winRate30d": r.get("source_win_rate_30d"),
                "winRate7d": r.get("source_win_rate_7d"),
                "netPnl30d": r.get("source_net_pnl_30d"),
                "netPnl7d": r.get("source_net_pnl_7d"),
                "currentUnrealizedPnl": r.get("open_unrealized"),
                "economics": (
                    (qualification.get("sourceQuality") or {}).get("economics")
                ),
