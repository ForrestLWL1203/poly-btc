...
class CopyPolicyTests(unittest.TestCase):
    def test_all_windows_and_selection_thresholds_share_one_versioned_policy(self):
        ...
        self.assertEqual(policy.stability_fold_count, 3)
        self.assertEqual(policy.stability_fold_days, 10)
        self.assertEqual(policy.stability_min_evaluable_folds, 2)
        self.assertEqual(policy.stability_min_profitable_folds, 2)
