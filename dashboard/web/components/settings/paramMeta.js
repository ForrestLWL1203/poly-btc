export const PARAM_META = {
  ...
  // scanner
  HARVEST_MIN_ACCT: { name: "钱包最低资金门槛", desc: "账户≥此金额才看", range: "$10k+", up: "只看大资金", dn: "纳入小资金、更杂" },
  HARVEST_WEEK_VLM_MIN: { name: "周成交量下限", desc: "只判断近期是否交易，不参与盈利效率计算", range: "$300k+" },
  HARVEST_WEEK_ROI_MIN: { name: "官方近7日 ROI 下限", desc: "Leaderboard 官方 ROI", range: "10%+" },
  HARVEST_MONTH_ROI_MIN: { name: "官方近30日 ROI 下限", desc: "Leaderboard 官方 ROI", range: "10%+" },
  HARVEST_ALL_ROI_MIN: { name: "官方历史 ROI 下限", desc: "Leaderboard 官方 ROI", range: "10%+" },
  HARVEST_WEEK_PNL_MIN: { name: "近7日绝对 PnL 下限", desc: "排除极小本金虚高 ROI", range: "$2k+" },
  HARVEST_MONTH_PNL_MIN: { name: "近30日绝对 PnL 下限", desc: "账户总 PnL 门槛", range: "$5k+" },
