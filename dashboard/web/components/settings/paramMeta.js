export const PARAM_META = {
  ...
  HARVEST_WEEK_ROI_MIN: { name: "官方近7日 ROI 下限", desc: "Leaderboard 官方 ROI", range: "15%+" },
  HARVEST_MONTH_ROI_MIN: { name: "官方近30日 ROI 下限", desc: "Leaderboard 官方 ROI", range: "20%+" },
  HARVEST_ALL_ROI_MIN: { name: "官方历史 ROI 下限", desc: "Leaderboard 官方 ROI", range: "20%+" },
  HARVEST_WEEK_PNL_MIN: { name: "近7日绝对 PnL 下限", desc: "排除极小本金虚高 ROI", range: "$2k+" },
  HARVEST_MONTH_PNL_MIN: { name: "近30日绝对 PnL 下限", desc: "账户总 PnL 门槛", range: "$8k+" },
