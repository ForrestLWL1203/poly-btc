  ...
  return (
    <React.Fragment>
      <div className="settings-section-head">
        <div><b>加仓执行规则</b><span>目标钱包加仓时，决定是否跟随、加多少以及最多跟几次</span></div>
      </div>
      <div className="settings-strategy-grid">
        <div className={"settings-strategy-card" + (openTiers.A ? " open" : "")}>
        ...
        <div className={"settings-strategy-card" + (bOpen ? " open" : "")}>
