...
Run via ``python3 -m dashboard.server``. Endpoints:
...
from .routes import dispatch_get as _dispatch_get
from .routes import dispatch_patch as _dispatch_patch
from .routes import dispatch_post as _dispatch_post
